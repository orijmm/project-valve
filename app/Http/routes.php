...
$router->post('binnacle/choose', [
    'as' => 'binnacle.date.choose',
    'uses' => 'BinnacleController@chooseDate'
]);

Route::get('binnacle/dairy/{hour}/{date}',[
    'as' => 'binnacle.form.parameter',
    'uses' => 'BinnacleController@getFormDiary'
    ]);

Route::get('binnacle/search/buscador', 'BinnacleController@buscador')->name('binnacle.buscador');