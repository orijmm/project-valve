    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
           <!--  <li class="sidebar-avatar">
            ...
            <li class="">
                <a href="#" class="">
                    <i class="fa fa-link fa-fw"></i> @lang('app.binnacle') <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-second-level collapse">
                <li>
                    <a href="{{route('binnacle.index')}}" class="">
                        @lang('app.diary_binnacle')
                    </a>
                </li>
                <li>
                    <a href="{{route('binnacle.buscador')}}" class="">
            ...
            <li class="">
                <a href="#" class="">
                    <i class="fa fa-link fa-fw"></i> Miselaneos <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-second-level collapse">
                <li>
                    <a href="{{route('classification.index')}}" class="">
                        Clasificaciones
                    </a>
                </li>
                <li>
                    <a href="{{route('parameter.index')}}" class="">
                        Parametros
                    </a>
                </li>
                <li>
                    <a href="{{route('hour.index')}}" class="">
                        Horas
                    </a>
                </li>
                </ul>
            ...
            @permission('users.activity')
                <li class="{{ Request::is('activity*') ? 'active open' : ''  }}">
                    <a href="{{ route('activity.index') }}" class="{{ Request::is('activity*') ? 'active' : ''  }}">
                        <i class="fa fa-link fa-fw"></i> @lang('app.activity_log')
                    </a>
                </li>
            @endpermission
            ...
            <li class="{{ Request::is('settings*') ? 'active open' : ''  }}">
                <a href="#">
                    <i class="fa fa-link fa-fw"></i> @lang('app.settings')
                    <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-second-level collapse">
